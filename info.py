...
PICS = (environ.get('PICS', 'https://telegra.ph/file/7fdabba7c2b10137beffd.jpg')).split()
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/f7f2a532fe4b990044507.mp4")
NOR_IMG = (environ.get("NOR_IMG","https://telegra.ph/file/7fdabba7c2b10137beffd.jpg")).split()
NEWGRP = environ.get("NEWGRP", "https://telegra.ph/file/7fdabba7c2b10137beffd.jpg")
CLOSE_IMG = (environ.get('CLOSE_IMG', 'https://telegra.ph/file/7fdabba7c2b10137beffd.jpg')).split()
JOIN_IMG = (environ.get('JOIN_IMG', 'https://telegra.ph/file/7fdabba7c2b10137beffd.jpg')).split()
                    
# Admins, Log, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5149183428 5238367049').split()]
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001537820228').split()]
